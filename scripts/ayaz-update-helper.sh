...
# Ankora Linux (Devuan Daedalus SysVinit) Kiosk Ortamı İçin Güvenli Kurulum Scripti
# Depo: https://github.com/Ankora-Linux/Ayaz
# ==============================================================================

set -e

DEB_PATH="${1:-/tmp/ayaz-update.deb}"
...
echo "[AYAZ GÜNCELLEYİCİ] Kurulum başlatılıyor: $DEB_PATH"

# 2. Dpkg ile Ayaz DE paketini kur
dpkg -i "$DEB_PATH" || {
